...
public class SigarUtils {
	 ...
	 private static Sigar sigar;  
		...
		memoryInfoList
				.add(new SigarInfoEntity(dft.format(mem.getTotal() * 1.0 / divisor) + "G",
	                "内存总量"));  
	        memoryInfoList.add(new SigarInfoEntity(  
				dft.format(mem.getUsed() * 1.0 / divisor) + "G", "当前内存使用量"));
	        memoryInfoList.add(new SigarInfoEntity(  
				dft.format(mem.getFree() * 1.0 / divisor) + "G", "当前内存剩余量"));
		...
		memoryInfoList
	        ...
	        memoryInfoList.add(new SigarInfoEntity(  
				dft.format(swap.getTotal() / divisor) + "G", "交换区总量"));
		memoryInfoList
				.add(new SigarInfoEntity(dft.format(swap.getUsed() / divisor) + "G", "当前交换区使用量"));
		memoryInfoList
				.add(new SigarInfoEntity(dft.format(swap.getFree() / divisor), "当前交换区剩余量"));
